...
" Attribute Sublexing
syn match makoAttributeKey containedin=makoTag,makoCustomTag contained "[a-zA-Z_][a-zA-Z0-9_]*="
...
syn match makoCustomDelim "</%\([a-zA-Z0-9_][a-zA-Z0-9_]*:[a-zA-Z_][a-zA-Z0-9_]*\)>" 
...
if version >= 508 || !exists("did_mako_syn_inits")
  ...
  HiLink makoCustomDelim Preproc
  HiLink makoCustomTag Keyword
